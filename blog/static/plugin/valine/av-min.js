!function (t, e) {
    ...
    return function (t) {
        ...
        (function (t, n) {
            ...
            !function () {
                var s = "object" == typeof self && self.self === self && self || "object" == typeof t && t.global === t && t || this || {},
                    ...
                    c = "undefined" != typeof Symbol ? Symbol.prototype : null, l = a.push, h = a.slice, f = u.toString,
                    d = u.hasOwnProperty, p = Array.isArray, _ = Object.keys, v = Object.create, y = function () {
                    }, m = function (t) {
                ...
                var x = function (t) {
                    var e = function (e, n, r, i) {
                        var s = !j(e) && m.keys(e), o = (s || e).length, a = t > 0 ? 0 : o - 1;
                ...
                var L = !{toString: null}.propertyIsEnumerable("toString"),
                    ...
                    q = function (t, e) {
                        var n = F.length, r = t.constructor, i = m.isFunction(r) && r.prototype || u, s = "constructor";
        ...
        "use strict";
        var r = n(0), i = n(44), s = n(0), o = s.extend, a = n(1), u = n(5), c = n(3), l = c.getSessionToken,
            h = c.ajax, f = function (t, e) {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = arguments[1],
                    n = {"X-LC-Id": u.applicationId, "Content-Type": "application/json;charset=UTF-8"}, r = !1;
                ...
                var e = t.service, n = void 0 === e ? "api" : e, r = t.version, i = void 0 === r ? "1.1" : r, s = t.path,
                    o = u._config.serverURLs[n];
                if (!o) throw new Error("undefined server URL for " + n);
                return "/" !== o.charAt(o.length - 1) && (o += "/"), o += i, s && (o += s), o
            }, v = function (t) {
                var e = t.service, n = t.version, i = t.method, s = t.path, o = t.query, a = t.data, c = t.authOptions,
                ...
                var d = u._config.requestTimeout, v = _({service: e, path: s, version: n});
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            ...
            }, i = n(0), s = n(8), o = n(6), a = o("leancloud:request"), u = o("leancloud:request:error"), c = n(1), l = 0,
            h = function (t) {
                var e = t.method, n = t.url, i = t.query, h = t.data, f = t.headers, d = void 0 === f ? {} : f,
                    p = t.onprogress, _ = t.timeout, v = {};
                if (i) for (var y in i) {
                    var m = i[y];
        ...
        "use strict";
        (function (e) {
            var r = n(0), i = n(9), s = n(6), o = n(22), a = n(3), u = a.inherits, c = a.parseDate, l = n(1),
                h = e.AV || {};
            h._config = {
                serverURLs: {},
                useMasterKey: !1,
                ...
                realtime: null,
                requestTimeout: null
            }, h._sharedConfig = {userAgent: o, liveQueryRealtime: null}, h._getAVPath = function (t) {
                ...
                if (r.isDate(t)) return i ? {__type: "Date", iso: t.toJSON()} : t.toJSON();
                ...
                if ("GeoPoint" === t.__type) return new h.GeoPoint({latitude: t.latitude, longitude: t.longitude});
                ...
                if ("File" === t.__type) {
                    var c = new h.File(t.name), l = r.clone(t);
        ...
        var d = n(24), p = n(25), _ = n(11), v = n(26), y = n(28), m = e = t.exports = function (t, n) {
        ...
        m.serializeObject = i, m.parseString = o, m.types = {
            ...
            if (this._withCredentials && (e.withCredentials = !0), !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof n && !this._isHost(n)) {
                var i = this._header["content-type"], s = this._serializer || m.serialize[i ? i.split(";")[0] : ""];
        ...
        "use strict";
        var r = n(0), i = n(1), s = n(31), o = ["getItem", "setItem", "removeItem", "clear"];
        ...
        "use strict";
        var r = n(12), i = n(5), s = e.removeAsync = r.removeItemAsync.bind(r), o = function (t, e) {
            try {
                t = JSON.parse(t)
            } catch (t) {
                return null
 ...
 */
        ...
        "use strict";
        var r = n(10), i = ["Browser"].concat(n(23));
 ...
 */
            !function (e, n) {
                ...
                var $ = Math.random().toString(36).substring(2), X = void 0, Y = 1, Z = 2, tt = {error: null}, et = 0,
                    nt = function () {
                        function t(t, e) {
        ...
        "use strict";
        (function (e) {
            var r = n(0), i = {}, s = ["getItem", "setItem", "removeItem", "clear"], o = e.localStorage;
            try {
                var a = "__storejs__";
        ...
        var i = n(5), s = n(34), o = n(3), a = o.isNullOrUndefined, u = n(0), c = u.extend, l = u.isObject,
            h = function (t) {
        ...
        i.init = function (t) {
            ...
            var e = t.appId, n = t.appKey, o = t.masterKey, a = (t.hookKey, t.serverURLs), u = t.disableCurrentUser,
            ...
            if (i._setServerURLs(c({}, r(e), i._config.serverURLs, "string" == typeof a ? h(a) : a), _), p) i._config.realtime = p; else if (i._sharedConfig.liveQueryRealtime) {
                var v = i._config.serverURLs, y = v.api, m = v.rtm;
            ...
            t.GeoPoint = function (e, n) {
                ...
                toJSON: function () {
                    ...
                    var e = Math.PI / 180, n = this.latitude * e, r = this.longitude * e, i = t.latitude * e,
                        s = t.longitude * e, o = n - i, a = r - s, u = Math.sin(o / 2), c = Math.sin(a / 2),
        ...
        "use strict";
        var r = n(0), i = n(41), s = n(42), o = n(43), a = n(4), u = n(2)._request, c = n(1), l = n(3), h = l.tap,
            f = l.transformFetchOptions, d = n(6)("leancloud:file"), p = n(47);
        t.exports = function (t) {
            var e = function () {
                ...
                return e.length = Math.ceil(t.length / 3), r.times(e.length, function (n) {
                    var r = t[3 * n], i = t[3 * n + 1] || 0, s = t[3 * n + 2] || 0, o = 3 * n + 1 < t.length,
                        a = 3 * n + 2 < t.length;
        ...
        !function () {
            var e = n(45), r = n(14).utf8, i = n(46), s = n(14).bin, o = function (t, n) {
 ...
 */
        ...
        var i = function () {
            ...
            }(), s = n(0), o = n(4), a = n(1), u = n(2), c = u._request, l = n(3), h = l.isNullOrUndefined,
            f = l.ensureArray, d = l.transformFetchOptions, p = l.setValue, _ = l.findValue, v = l.isPlainObject,
            y = function t(e) {
            ...
            t.Object = function (e, n) {
                ...
                _fetchWhenSave: !1, initialize: function () {
                    ...
                    delete this.attributes[e], this._serverData[e] && (this.attributes[e] = this._serverData[e]), t._arrayEach(this._opSetQueue, function (r) {
                        var s = r[e];
                        if (s) {
                            var o = _(n.attributes, e), a = i(o, 4), u = a[0], c = a[1], l = a[2], h = a[3];
        ...
        var i = n(0), s = n(9), o = n(4), a = n(2), u = a._request, c = a.request, l = n(1), h = function () {
            ...
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = e.preferUnionId,
                r = e.unionIdPlatform, i = void 0 === r ? "weixin" : r, s = e.asMainAccount, o = void 0 === s || s;
            return n ? {platform: i, main_account: o, code: t} : {code: t}
        }, d = function (t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = n.unionIdPlatform,
                s = void 0 === r ? "weixin" : r, a = n.asMainAccount, u = void 0 !== a && a;
            ...
            return i.extend({}, t, {platform: s, unionid: e, main_account: Boolean(u)})
        };
        t.exports = function (t) {
            t.User = t.Object.extend("_User", {
                _isCurrentUser: !1, _mergeMagicFields: function (e) {
                    ...
                    var s, o = this, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                ...
                _fetchUserBySessionToken: function (e) {
                    ...
                    return c({method: "GET", path: "/users/me", authOptions: {sessionToken: e}}).then(function (t) {
                        var e = n.parse(t);
        ...
        "use strict";
        var r = n(0), i = n(6)("leancloud:query"), s = n(1), o = n(4), a = n(2), u = a._request, c = a.request,
            l = n(3), h = l.ensureArray, f = l.transformFetchOptions, d = function (t, e) {
        ...
        t.exports = function (t) {
            t.Query = function (e) {
                ...
                _processResult: function (t) {
                    ...
                    var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        n = e.orderedBy, o = e.batchSize, a = arguments[1], c = this.toJSON();
        ...
        "use strict";
        var r = n(0), i = n(53), s = n(1), o = n(3), a = o.inherits, u = n(2), c = u.request, l = function (t, e) {
        ...
        t.exports = function (t) {
            ...
            t.LiveQuery = a(i, {
                ...
                init: function (n) {
                    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = r.subscriptionId,
        ...
        var i = n(0), s = n(1), o = n(2), a = o.request, u = n(3), c = u.ensureArray, l = u.parseDate, h = n(5);
        ...
        h.Leaderboard.createWithoutData = function (t) {
            ...
            var n = t.statisticName, r = t.order, i = t.versionChangeInterval, s = t.updateStrategy;
            return a({
                method: "POST",
                path: "/leaderboard/leaderboards",
                data: {statisticName: n, order: r, versionChangeInterval: i, updateStrategy: s},
                authOptions: e
            }).then(function (t) {
            ...
            _finishFetch: function (t) {
                ...
                var r = t.skip, i = t.limit, s = t.selectUserKeys, o = t.includeStatistics, u = t.version;
                return a({
                    method: "GET",
                    ...
                    return t.results.map(function (t) {
                        var e = h._decode(t), n = e.user, r = e.statisticValue, i = e.rank, s = e.statistics;
                        return {user: n, value: r, rank: i, includedStatistics: (void 0 === s ? [] : s).map(f)}
                    })
                })
            }, getResults: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = t.skip, n = t.limit,
                    r = t.selectUserKeys, i = t.includeStatistics, s = t.version, o = arguments[1];
                return this._getResults({skip: e, limit: n, selectUserKeys: r, includeStatistics: i, version: s}, o)
                ...
                var r = e.limit, i = e.selectUserKeys, s = e.includeStatistics, o = e.version;
                ...
                return a({
                    ...
                    return e.results.map(function (e) {
                        var n = e.version, r = e.status, i = e.url, s = e.activatedAt, o = e.deactivatedAt;
                        return {
